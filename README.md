...
2. [Configuration](#configuration).
  ...
  * [Setting of authentication type](#setting-authentication-type).
...
## Logging
It is possible to log outgoing requests and incoming responses using `logHttp` property of `RestClientConfiguration`:
```java
